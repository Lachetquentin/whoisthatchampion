...
import VictoryPng from 'lol/images/Victory.png';

interface LolWinModalProps {
  dailyChampion: any;
  nbTry: number;
  gameIndex: number;
}
...
const LolWinModal: React.FC<LolWinModalProps> = ({
  dailyChampion,
  nbTry,
  gameIndex,
}) => {
  ...
  const shareScore = () => {
    ...
    share = share + '\nhttps://whoisthatchampion.vercel.app/lol';
  ...
  return (
    <Modal isOpen={true} style={modalStyles}>
      ...
      <p className="font-bold">https://whoisthatchampion.vercel.app/lol</p>
      <br />
      <p className="appColor font-semibold">
